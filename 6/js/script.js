...
class FullPageScroll {
  constructor() {
    ...
    this.screenFiller = document.querySelector(`.screen__background`);
...
/***/ "./source/js/modules/text-animation.js":
/*!*********************************************!*\
  !*** ./source/js/modules/text-animation.js ***!
  \*********************************************/
/*! exports provided: default */
...
/* harmony import */ var _modules_text_animation_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/text-animation.js */ "./source/js/modules/text-animation.js");
// modules
...
const animationTitle = new _modules_text_animation_js__WEBPACK_IMPORTED_MODULE_9__["default"] (`.intro__title`, 600, `active-animation`, `transform`, 100, 30, false);
animationTitle.runAnimation();

const animationDate = new _modules_text_animation_js__WEBPACK_IMPORTED_MODULE_9__["default"] (`.intro__date`, 400, `active-animation`, `transform`, 500, 20, true);
animationDate.runAnimation();

const sliderTitle = new _modules_text_animation_js__WEBPACK_IMPORTED_MODULE_9__["default"] (`.slider__item-title`, 600, `active-animation`, `transform`, 0, 30, true);
sliderTitle.runAnimation();

const prizesTitle = new _modules_text_animation_js__WEBPACK_IMPORTED_MODULE_9__["default"] (`.prizes__title`, 600, `active-animation`, `transform`, 0, 30, true);
prizesTitle.runAnimation();

const rulesTitle = new _modules_text_animation_js__WEBPACK_IMPORTED_MODULE_9__["default"] (`.rules__title`, 600, `active-animation`, `transform`, 0, 30, true);
rulesTitle.runAnimation();

const gameTitle = new _modules_text_animation_js__WEBPACK_IMPORTED_MODULE_9__["default"] (`.game__title`, 600, `active-animation`, `transform`, 0, 30, true);
